...
//       `::set-output name=added::${JSON.stringify(FILES_ADDED, 4)}`
//     );
//     process.stdout.write(
//       `::set-output name=deleted::${JSON.stringify(FILES_DELETED, 4)}`
//     );
//     process.stdout.write(
//       `::set-output name=modified::${JSON.stringify(FILES_MODIFIED, 4)}`
//     );
//     process.stdout.write(
//       `::set-output name=renamed::${JSON.stringify(FILES_RENAMED, 4)}`
//     );
